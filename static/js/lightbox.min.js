    ...
    return b.defaults={
        ...
        b.prototype.build=function(){
            ...
            a('<div id="lightboxOverlay" class="lightboxOverlay"></div>' +
                    ...
                    '<div class="row top_space" >' +
                        '<div class="col-md-offset-5"></div>' +
                            '<div class="col-md-offset-5">' +
                                '<a href="'+/getNiitDunruu?number={{ number }}+'" class="ks_btn ks_btn_buy1 " >'+
                ...
                return b.end(),!1
            //}),this.$lightbox.find(".ks_btn .ks_btn_buy, .ks_text").on("click", function () {
                return sdsa
            })
        },
        b.prototype.start=function(b){
            ...
            var d=this,e=a(window);e.on("resize",a.proxy(this.sizeOverlay,this)),a("select, object, embed").css({
                visibility:"hidden"
        ...
        b.prototype.sizeContainer=function(a,b){
            ...
            var d=this,e=this.$outerContainer.outerWidth(),f=this.$outerContainer.outerHeight(),g=a+this.containerPadding.left+this.containerPadding.right+this.imageBorderWidth.left+this.imageBorderWidth.right,h=b+this.containerPadding.top+this.containerPadding.bottom+this.imageBorderWidth.top+this.imageBorderWidth.bottom;e!==g||f!==h?this.$outerContainer.animate({width:g,height:h},this.options.resizeDuration,"swing",function(){c()}):c()
        },
        ...
        b.prototype.keyboardAction=function(a){
            var b=27,c=37,d=39,e=a.keyCode,f=String.fromCharCode(e).toLowerCase();e===b||f.match(/x|o|c/)?this.end():"p"===f||e===c?0!==this.currentImageIndex?this.changeImage(this.currentImageIndex-1):this.options.wrapAround&&this.album.length>1&&this.changeImage(this.album.length-1):("n"===f||e===d)&&(this.currentImageIndex!==this.album.length-1?this.changeImage(this.currentImageIndex+1):this.options.wrapAround&&this.album.length>1&&this.changeImage(0))
        },
