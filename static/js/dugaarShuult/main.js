function prefixOronguud(prefix, numbertype) {
...
function number(numbertype, az) {
    ...
    if (numbertype == "7") {
        ...
        if (az == 6) {
            ...
            return document.getElementById('digit12').value + document.getElementById('digit3').value + document.getElementById('digit4').value + document.getElementById('digit5678').value;
        }
    }
}
...
function order(number, luck) {
    ...
    var url = protocol + "//" + host + "/numberPrice?user_id=" + user_id + "&number=" + number + "&numbertype=" + numbertype + "&az=" + az;
