...
class AssetDetailsData(models.Model):
    assetslipid = models.IntegerField(db_column='AssetSlipID', blank=True, null=True)  # Field name made lowercase.
    assetgroupname = models.CharField(db_column='AssetGroupName', max_length=50, blank=True, null=True)  # Field name made lowercase.
    assetname = models.CharField(db_column='AssetName', max_length=250, blank=True, null=True)  # Field name made lowercase.
    assetbarcode = models.CharField(db_column='AssetBarCode', max_length=200, blank=True, null=True)  # Field name made lowercase.
    returnis = models.CharField(db_column='ReturnIs', max_length=200, blank=True, null=True)  # Field name made lowercase.
    seleccion = models.CharField(db_column='Seleccion', max_length=200, blank=True, null=True)
    lenghtcable = models.IntegerField(db_column='LenghtCable', blank=True, null=True)  # Field name made lowercase.
...
class AssetFirmData(models.Model):
    assetpackagedataid = models.CharField(db_column='assetPackageDataId', max_length=200)  # Field name made lowercase.
...
class AssetPackageData(models.Model):
    assetslipid = models.IntegerField(db_column='AssetSlipID', blank=True, null=True)  # Field name made lowercase.
    locationfrom = models.CharField(db_column='LocationFrom', max_length=100, blank=True, null=True)  # Field name made lowercase.
    locationto = models.CharField(db_column='LocationTo', max_length=100, blank=True, null=True)  # Field name made lowercase.
    createddate = models.DateField(db_column='CreatedDate')  # Field name made lowercase.
    location_id = models.CharField(db_column='Location_ID', max_length=200, blank=True, null=True)  # Field name made lowercase.
    locationfrom_id = models.CharField(db_column='LocationFrom_ID', max_length=200, blank=True, null=True)  # Field name made lowercase.
    userfrom = models.CharField(db_column='UserFrom', max_length=200, blank=True, null=True)  # Field name made lowercase.
    userto = models.CharField(db_column='UserTo', max_length=200, blank=True, null=True)  # Field name made lowercase.
    gazar = models.CharField(max_length=200, blank=True, null=True)
    reasonvalue = models.CharField(db_column='ReasonValue', max_length=200, blank=True, null=True)  # Field name made lowercase.
    uploadfile = models.TextField(db_column='UploadFile', blank=True, null=True)  # Field name made lowercase.
    status = models.CharField(max_length=200, blank=True, null=True)
...
class Data(models.Model):
    ...
    assetslipid = models.IntegerField(db_column='AssetSlipID', blank=True, null=True)  # Field name made lowercase.
    assetgroupname = models.CharField(db_column='AssetGroupName', max_length=50, blank=True, null=True)  # Field name made lowercase.
    assetname = models.CharField(db_column='AssetName', max_length=50, blank=True, null=True)  # Field name made lowercase.
    assetbarcode = models.CharField(db_column='AssetBarCode', max_length=200, blank=True, null=True)  # Field name made lowercase.
    locationfrom = models.CharField(db_column='LocationFrom', max_length=100, blank=True, null=True)  # Field name made lowercase.
    locationto = models.CharField(db_column='LocationTo', max_length=100, blank=True, null=True)  # Field name made lowercase.
    createddate = models.DateField(db_column='CreatedDate')  # Field name made lowercase.
    ...
    userfrom = models.CharField(db_column='UserFrom', max_length=200, blank=True, null=True)  # Field name made lowercase.
    userto = models.CharField(db_column='UserTo', max_length=200, blank=True, null=True)  # Field name made lowercase.
    tagheltesiindarga = models.IntegerField(db_column='tagHeltesiinDarga', blank=True, null=True)  # Field name made lowercase.
    tagzahiral = models.IntegerField(db_column='tagZahiral', blank=True, null=True)  # Field name made lowercase.
    ttgheltesiindarga = models.IntegerField(db_column='ttgHeltesiinDarga', blank=True, null=True)  # Field name made lowercase.
    ttgzahiral = models.IntegerField(db_column='ttgZahiral', blank=True, null=True)  # Field name made lowercase.
    sbgzahiral = models.IntegerField(db_column='sbgZahiral', blank=True, null=True)  # Field name made lowercase.
    gazar = models.CharField(max_length=200, blank=True, null=True)
    returnis = models.CharField(db_column='ReturnIs', max_length=200, blank=True, null=True)  # Field name made lowercase.
    assetid = models.IntegerField(db_column='AssetID', blank=True, null=True)  # Field name made lowercase.
    agreed = models.CharField(db_column='Agreed', max_length=200, blank=True, null=True)  # Field name made lowercase.
    canceluser = models.IntegerField(db_column='CancelUser', blank=True, null=True)  # Field name made lowercase.
    cancelagreed = models.IntegerField(db_column='CancelAgreed', blank=True, null=True)  # Field name made lowercase.
    reasonvalue = models.CharField(db_column='ReasonValue', max_length=200, blank=True, null=True)  # Field name made lowercase.
    uploadfile = models.TextField(db_column='UploadFile', blank=True, null=True)  # Field name made lowercase.
    lenghtcable = models.IntegerField(db_column='LenghtCable', blank=True, null=True)  # Field name made lowercase.
    status = models.CharField(max_length=200, blank=True, null=True)
...
class SimpleDataTest(models.Model):
    packagecode = models.CharField(db_column='packageCode', max_length=200)  # Field name made lowercase.
    userid = models.CharField(db_column='userId', max_length=200)  # Field name made lowercase.
    username = models.CharField(db_column='userName', max_length=200)  # Field name made lowercase.
    headid = models.CharField(db_column='headId', max_length=200)  # Field name made lowercase.
...
class SimpleProductsOld(models.Model):
    nyaraviinturul = models.CharField(db_column='nyaraviinTurul', max_length=200, blank=True, null=True)  # Field name made lowercase.
    diamondcode = models.CharField(db_column='diamondCode', max_length=200, blank=True, null=True)  # Field name made lowercase.
    turul = models.CharField(max_length=200, blank=True, null=True)
    dedturul = models.CharField(db_column='dedTurul', max_length=200, blank=True, null=True)  # Field name made lowercase.
...
class SimpleProductsTypeOld(models.Model):
...
class SimpleTreasurersTypeOld(models.Model):
    treasurer = models.CharField(max_length=200)
